    ...
    <div className="footer">
      <div className="footer__wrapper">
        <div className="footer__social">
          <div className="footer__social-logo">
            ...
            <ul className="footer__social-list">
              ...
              <li className="footer__social-item">youtube</li>
              <li className="footer__social-item">twit </li>
              <li className="footer__social-item">pint</li>
              <li className="footer__social-item">inst</li>
            </ul>
          </div>
        ...
        <div className="footer__request">
          <button className="footer__request-button">Request Invite</button>

          <div className="footer__request-rigths">
